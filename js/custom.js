          ...
          "arabic": {
            "translation": {
              "views": {
                ...
                "experience": "الخبرة",
                "hello": "مرحبًا!",
                "name": "أنا شاهِد إقبال.",
                "intro": "بصفتي محترفًا مكرسًا، أنا فخور بأخلاقيات العمل القوية التي أتمتع بها وحرصي الدائم على تحسين الذات. بفضل سجلّي في الالتزام بالمواعيد ونهج استباقي في التعلم، أُشجّع بيئة عمل إيجابية وتعاونية. أبرع في العمل بشكل مستقل وكجزء من فريق، وأزدهر في البيئات سريعة الوتيرة. تجعلني مهاراتي الفعّالة في التواصل وحل المشكلات ماهرًا في الاستماع وحل التحديات بحس tact وبدوافع متنوعة وشغف بالتعلم.",
                "thankyou": "شكرًا لوقتك. أتطلع إلى التواصل معك.",
                "view_works": "عرض الأعمال",
                "who_am_i": "من أنا؟",
                "about_me": "عنّي",
                "bio": "السيرة الذاتية",
                "bio_details": "أنا شاهِد إقبال، مهندس برمجيات شغوف ببناء تطبيقات الويب القوية. مع أكثر من عقد من الخبرة في Ruby on Rails، أتيحت لي الفرصة للعمل على مشاريع متنوعة صقلت مهاراتي في تطوير الواجهة الخلفية وهندسة النظم. بجانب Rails، أنا ماهر في PostgreSQL لإدارة قواعد البيانات، ولدي فهم قوي لتقنيات الواجهة الأمامية مثل HTML وCSS وjQuery. مؤخرًا، بدأت أيضًا في استكشاف Python لمرونتها في مهام البرمجة والتلقائي.",
                "age": "العمر",
                "residence": "الإقامة",
                "japan": "اليابان",
                ...
                "what_can_i_do": "ماذا يمكنني أن أفعل؟",
                "my_skills": "مهاراتي",
                "gcp_desc": "الاستفادة من مجموعة خدمات GCP لتصميم هياكل سحابية قابلة للتوسع ومرنة. مع خبرة عملية في الحوسبة السحابية.",
                "front_end_development": "تطوير الواجهة الأمامية (HTML/CSS/jQuery)",
                "front_end_development_desc": "أتخصص في HTML وCSS وjQuery ولدي عين حريصة على تصميم واجهة المستخدم. لدي قاعدة قوية في هذه التقنيات.",
                "python": "بايثون",
                "ansible": "Ansible (أداة مفتوحة المصدر لأتمتة تكنولوجيا المعلومات)",
                "ansible_desc": "الاستفادة من قدرات Ansible القوية لتبسيط عمليات إدارة البنية التحتية وأتمتة المهام عبر بيئات متنوعة.",
                "what_do_i_do": "ماذا أفعل؟",
                "backend_development": "تطوير الواجهة الخلفية",
                "backend_development_desc": "مع أكثر من عقد من الخبرة في Ruby on Rails، أتميز في بناء حلول خادم قابلة للتوسع وفعالة.",
                "api_development": "تطوير واجهات برمجة التطبيقات",
                "api_development_desc": "أتمتع بخبرة واسعة في بناء APIs قوية باستخدام Ruby on Rails وFastAPI، مع قاعدة قوية في كلا الإطارين.",
                "education_experience": "التعليم والخبرة",
                "resume": "السيرة الذاتية",
                "resume_name": "شاهِد إقبال",
                "tokyo": "طوكيو",
                "experienced_in_ruby_on_rails": "ذو خبرة في تطوير الويب باستخدام Ruby on Rails، وإدارة دورة حياة المشروع (التحليل، التصميم، التطوير، قيادة الفريق، النشر، الاختبار، التوثيق، الصيانة، الدعم الفني)، مع خبرة في بنية MVC، HTML5، Bootstrap، تكامل RESTful API، وGit/GitHub/Bitbucket، مع عرض حل المشكلات بشكل استباقي والقدرة على التكيف.",
                "work_experiences": "خبرات العمل",
                "senior_software_engineer": "مهندس برمجيات أول",
                "software_engineer": "مهندس برمجيات",
                "contract_software_developer": "مطور برمجيات بعقد",
                "software_analyst": "محلل برمجيات",
                "protea": "PROTEA JAPAN | 2022 - حتى الآن",
                "protea_desc": "قيادة جهود تطوير الميزات وإصلاح الأخطاء، لضمان وظيفة تطبيق قوية وتجربة مستخدم مثلى. إجراء مراجعات شاملة للرمز وإدارة الشيفرة المصدرية باستخدام Gitlab، مع فرض معايير عالية وتعزيز التعاون. الإشراف على إنشاء البناء والنشر عبر بيئات متعددة، وتنفيذ الأتمتة من أجل الكفاءة. التعاون الوثيق مع المصممين لتنفيذ واجهات المستخدم البديهية والقابلة للوصول. الاستفادة من مهارات تقنية متنوعة لحل المشكلات المعقدة ودفع الابتكار. توفير الإرشاد والقيادة التقنية وتعزيز بيئة الفريق التعاونية، لضمان تسليم المشاريع بنجاح والتنسيق عبر الفرق متعددة التخصصات.",
                "vebuin": "VeBuIn | 12 2018 - 01 2022",
                "vebuin_desc": "بصفتي مهندس برمجيات في VeBuIn Pvt. Ltd., استخدمت Ruby on Rails لتطوير وصيانة حلول برمجية عالية الجودة. التزمت دائمًا بمبادئ البرمجة النظيفة لضمان قابلية الصيانة والتوسع في الشيفرة. عملت ضمن فريق Scrum، وساهمت في تحسينات تكرارية وتدريجية، وفعّلت التعاون مع الفرق متعددة التخصصات لتقديم ميزات قوية وحل القضايا المعقدة. كان دوري يتطلب التزامًا قويًا بأفضل ممارسات هندسة البرمجيات والتحسين المستمر.",
                "sodel_solutions": "Sodel Solutions | 07 2018 - 12 2018",
                "sodel_solutions_desc": "في Sodel Solutions Inc., عملت كمهندس برمجيات متخصص في Ruby on Rails. شمل دوري تطوير وصيانة واجهات برمجة التطبيقات، وتكامل Active Admin لإدارة الواجهة الخلفية بكفاءة، والالتزام بمبادئ البرمجة النظيفة لكتابة شيفرة قابلة للصيانة والتوسع. عملت ضمن فريق Scrum، ولعبت دورًا رئيسيًا في تقديم تحسينات تكرارية والتعاون مع الفرق متعددة التخصصات لضمان حلول برمجية عالية الجودة.",
                "unikaihatsu": "Unikaihatsu Software | 11 2016 - 07 2018",
                "unikaihatsu_desc": "في Unikaihatsu Software Pvt. Ltd., عملت كمهندس برمجيات، مستفيدًا من Ruby on Rails وPostgreSQL لتطوير تطبيقات قوية وقابلة للتوسع. استخدمت Bootstrap لإنشاء واجهات مستخدم استجابية وجذابة بصريًا. التزامي بممارسات البرمجة النظيفة ضمن جودة الشيفرة، وتجربتي في Scrum سهلت التعاون الفعال ضمن الفرق المرنة. ساهمت في تقديم حلول برمجية عالية الجودة من خلال دمج هذه التقنيات والمنهجيات.",
                "excel_infoways": "Excel Infoways Ltd | 03 2016 - 11 2016",
                "excel_infoways_desc": "بصفتي مهندس برمجيات في Excel Infoways Ltd، تخصصت في تطوير Ruby on Rails مع التركيز الشديد على بناء واجهات برمجة التطبيقات القابلة للتوسع لمنصات التجارة الإلكترونية. طبقت دائمًا ممارسات البرمجة النظيفة لضمان قواعد شيفرة قابلة للصيانة وفعالة. شمل دوري التعاون الوثيق مع الفرق متعددة التخصصات لتقديم حلول برمجية مخصصة تلبي المتطلبات الفريدة للأعمال التجارية الإلكترونية. ساهمت خبرتي في تطوير واجهات برمجة التطبيقات وحلول التجارة الإلكترونية بشكل كبير في تعزيز القدرات التكنولوجية للشركة وتحقيق الأهداف التجارية بفعالية.",
                "cerebrate": "Cerebrate, Inc | 11 2015 - 03 2016",
                "cerebrate_desc": "في Cerebrate, Inc., بدأت كمطور Rails وانتقلت بسرعة للعمل مع مجموعة MEAN (MongoDB وExpress.js وAngular.js وNode.js). كان هذا التحول حاسمًا في توسيع مهاراتي والعمل مع تقنيات متطورة. ازدهرت في ثقافة الابتكار والتعاون في Cerebrate، حيث تم تمكيني من تحقيق أفكار جديدة. هذه البيئة الديناميكية تتحدى باستمرار للوصول إلى مستويات جديدة.",
                "botree": "BoTree Technologies Pvt. Ltd. | 02 2015 - 10 2015",
                "botree_desc": "في دوري في BoTree Technologies Pvt Ltd، كنت مسؤولًا عن إضافة وحدات جديدة باستخدام Ruby on Rails. لم يسمح لي هذا التجربة فقط بشحذ قدراتي التقنية، ولكن أيضًا علمتني أهمية العمل الجماعي وإدارة المشاريع بفعالية. أعتقد أن التعاون والتواصل الفعال هما المفتاح لتقديم مشاريع ناجحة.",
                "sharingdais": "Sharingdais | 09 2014 - 12 2014",
                "sharingdais_desc": "كانت Sharingdais.com شركة ناشئة قائمة على المنتج. انضممت إلى هذه الشركة كمهندس برمجيات وكانت مسؤوليتي إضافة ميزات جديدة وحل الأخطاء. تم بناء هذا الموقع باستخدام Rails وBootstrap.",
                "dreamsoft4u": "DreamSoft4u Pvt. Ltd. | 07 2014 - 09 2014",
                "dreamsoft4u_desc": "بينما كانت وظيفتي السابقة تركز في الغالب على jQuery وتكامل الإضافات، أردت أن أتحدّى نفسي وأرى كيف سأؤدي العمل بشكل مستقل على ميزة باستخدام Ruby on Rails. لذلك قررت قبول وظيفة عقدية في DreamSoft4u Pvt. Ltd. خلال وقتي في DreamSoft4u Pvt. Ltd، أتيحت لي الفرصة للعمل على مشاريع مثل Shopify وتطبيق دردشة صغير. لم تقم هذه التجارب بصقل مهاراتي التقنية فحسب، بل علمتني أيضًا أهمية القدرة على التكيف وحل المشكلات.",
                "kartik_solutions": "Kartik Solutions Pvt. Ltd. | 06 2013 - 06 2014",
                "kartik_solutions_desc": "بدأ اهتمامي بـ Ruby on Rails عندما كنت أعمل في شركتي السابقة، التي كانت تستخدم الإطار أيضًا في الواجهة الخلفية. كنت مفتونًا بقدراته وكنت أعلم أنني أرغب في معرفة المزيد. لذلك، قمت بالبدء في تعلم Ruby وبعد 3 أشهر فقط، تمكنت من تأمين أول فرصة لي كمطور واجهة خلفية. في Kartik Solutions Pvt. Ltd، كنت مسؤولًا عن صيانة وتعزيز موقعنا الحالي. أعطتني هذه التجربة الفرصة للعمل مع إضافات وأدوات مختلفة، بما في ذلك تكامل Fitbit لمستخدمينا. كانت تجربة مليئة بالتحديات ولكنها مجزية، حيث تمكنت من الاستمرار في التعلم والنمو كمطور.",
                "beryl_systems": "Beryl Systems | 12 2012 - 05 2013",
                "beryl_systems_desc": "بدأت مسيرتي المهنية في Beryl Systems، حيث أتيحت لي الفرصة للعمل مع إطار Bootstrap وصقل مهاراتي في jQuery وBootstrap. خلال وقتي في Beryl Systems، كنت مسؤولًا عن إنشاء صفحات جديدة وتحسين تصميم الصفحات الحالية. سمح لي ذلك بعرض إبداعي وتحسين تجربة المستخدم العامة لعملائنا.",
                "projects": "المشاريع",
                "right_on": "RightOn",
                "right_on_desc": "هذا موقع تجارة إلكترونية متخصص في بيع الملابس. تُدرج منتجاته أيضًا على منصات تجارة إلكترونية أخرى مثل Rakuten و&mall وMagaseek وPayPay وغيرها. تم تصميم النظام لتتبع الطلبات من هذه المنصات، وإرسالها إلى المستودع، وإدارة شحنات الطلبات، والحفاظ على سجلات المخزون.",
                "right_on_hr": "RightOn (نظام الموارد البشرية)",
                "confidential": "سري",
                "right_on_hr_desc": "تم تصميم هذا النظام كحل لتخزين البيانات لقسم الموارد البشرية في شركة. يعمل كنظام سير عمل حيث يمكن للموظفين التقدم بطلبات الإجازات والمصروفات وطلبات أخرى. يتم توجيه الطلبات في البداية إلى المديرين للموافقة ثم إلى الموارد البشرية للموافقة النهائية. يتيح النظام للمديرين وأفراد الموارد البشرية تعديل خطوات سير العمل حسب الحاجة، مثل زيادة أو تقليص تسلسل الموافقة.",
                "giftcardspread": "Giftcardspread",
                "giftcardspread_desc": "كان هذا النظام في الأصل نظامًا فرعيًا لـ Giftcardspread. وظيفته الأساسية هي إدارة أسعار المنتجات من خلال مقارنتها بأسعار من أنظمة أخرى.",
                "whiskk": "Whiskk",
                "na": "غير متوفر",
                "whiskk_desc": "كان تطبيقًا اجتماعيًا مصممًا لتسهيل التفاعل الاجتماعي والدعم داخل المجتمع. كان الهدف من التطبيق تلبية الاحتياجات المتنوعة للأفراد الذين يعيشون في نفس المجتمع من خلال تعزيز المساعدة المتبادلة والاتصالات.",
                "advowire": "Advowire",
                "advowire_desc": "AdvoWire يسهل التواصل بين المدونين، مستخدمي وسائل التواصل الاجتماعي، العلامات التجارية، والوكالات لحملات التسويق عبر المؤثرين والكلمة الشفهية. يقوم المستخدمون بإنشاء ملفات تعريف 'المدافع' ويتلقون حوافز للمشاركة في الحملات ذات الصلة. يتم تحديد الأهلية بناءً على توافق الصناعة، نطاق الشبكة، والموقع الجغرافي. يتم ضمان مصداقية شبكات المدافعين من خلال طرق التحقق المدمجة لتقليل الاتصالات والمتابعين المزيفين أو غير النشطين، مما يعزز فعالية الحملة ومصداقيتها.",
                "sharingdais": "Sharingdais",
                "sharingdais_desc": "تعمل هذه المنصة كخدمة إدراج عبر الإنترنت للأنشطة من نظير إلى نظير (P2P) مثل مشاركة الطعام، المهارات، والكتب. يمكن للمستخدمين عرض واكتشاف هذه الخدمات على المنصة، التعبير عن الاهتمام بالقوائم، والتواصل مع مستخدمين آخرين لأغراض المشاركة. المنصة متاحة حاليًا للمستخدمين في مناطق بنغالور وNCR (المنطقة الوطنية للعاصمة).",
                "tmo": "TMO (TomrMenOutfit)",
                "tmo_desc": "كان نظام دردشة مصممًا خصيصًا للتواصل بين الخياطين والعملاء.",
                "sharemeister": "Sharemeister",
                "sharemeister_desc": "Sharemeister هو خدمة برمجيات تقدم سوقًا للموارد المصممة لتوسيع أي تطبيق رقمي.",
                "pinni_insurance": "Pinni Insurance",
                "pinni_insurance_desc": "كان هذا المشروع هو الأول الذي عملت عليه. شمل تصميم نظام لإدارة البيانات خصيصًا لشركة تأمين.",
                "skills": "المهارات",
                "technical": "تقني",
                "shopify": "Shopify",
                "ruby_on_rails": "Ruby on Rails",
                ...
                "ansible": "Ansible",
                "docker": "Docker",
                "clean_coding": "البرمجة النظيفة",
                "code_review": "مراجعة الشيفرة",
                "scrum": "Scrum",
                "gitlab": "GitLab",
                "gitHub": "GitHub",
                "bitbucket": "Bitbucket",
                ...
                "ruby_python": "Ruby/Python",
                "postgre_mysql": "PostgreSQL/MySQL",
                "object_oriented_design": "تصميم موجه للكائنات",
                "design_and_implement_database_structures": "تصميم وتنفيذ هياكل قواعد البيانات",
                "lead_and_deliver_complex_software_systems": "قيادة وتقديم أنظمة برمجيات معقدة",
                "professional": "محترف",
                "effective_communication": "تواصل فعال",
                "team_player": "عضو فريق",
                "strong_problem_solver": "حل مشاكل قوي",
                "good_time_management": "إدارة وقت جيدة",
                "education": "التعليم",
                "bachelor_of_technology": "بكالوريوس في التكنولوجيا في علوم الكمبيوتر",
                "university": "الجامعة: جامعة فير بهاردور سينغ بورفانشال، جاونبور",
                "languages": "اللغات",
                "hindi": "الهندية",
                "english": "English",
                "japanese": "日本語",
